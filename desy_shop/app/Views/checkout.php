...
<html lang="en">
  <head>
    ...
    <title>Chart - Desy shop online</title>
        ...
        <div class="row mb-5 g-3">
            <div class="col-12">
                <div class="row p-3 bg-danger-subtle g-3">
                    <div class="row">
                    <div class="col-4">
                        <img src="<?= base_url ('images/bluse.jpeg.')?>"alt="" style="width: 200px; height: auto">
                    </div>
                    <div class="col-4 d-flex flex-column justify-content-center">
                        <span><h5>bluse</h5></span>
                        <p>85,000,-</p>
                    </div>
            ...
            <div class="col-12">
                <div class="row p-3 bg-danger-subtle g-3">
                    <div class="row">
                    <div class="col-4">
                        <img src="<?= base_url ('images/bluse.jpeg.png')?>"alt="" style="width: 200px; height: auto">
                    </div>
                    <div class="col-4 d-flex flex-column justify-content-center">
                        <span><h5>bluse</h5></span>
                        <p>85,000,-</p>
